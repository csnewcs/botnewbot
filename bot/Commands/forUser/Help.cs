...
namespace bot
{
    ...
    public class Help : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task help()
        {
            ...
            .AddField("기타 명령어", "이 외의 나머지 명령어를 보시려면 :guitar:")
            ...
            try
            {
                Emoji[] emojis = new Emoji[6] {
                    new Emoji("\U0001f4b0"), new Emoji("\U0001f4b8"), new Emoji("\U0001f3c6"), new Emoji("\U0001f3a4"), new Emoji("\U0001f6e0"), new Emoji("\U0001F3B8")
                };
